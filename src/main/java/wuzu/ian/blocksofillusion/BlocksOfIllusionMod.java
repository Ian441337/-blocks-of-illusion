package wuzu.ian.blocksofillusion;

import wuzu.ian.blocksofillusion.init.BlocksOfIllusionModTabs;
import wuzu.ian.blocksofillusion.init.BlocksOfIllusionModItems;
import wuzu.ian.blocksofillusion.init.BlocksOfIllusionModBlocks;
...
@Mod("blocks_of_illusion")
public class BlocksOfIllusionMod {
	public static final Logger LOGGER = LogManager.getLogger(BlocksOfIllusionMod.class);
	public static final String MODID = "blocks_of_illusion";

	public BlocksOfIllusionMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		BlocksOfIllusionModBlocks.REGISTRY.register(bus);

		BlocksOfIllusionModItems.REGISTRY.register(bus);

		BlocksOfIllusionModTabs.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									BlocksOfIllusionMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			BlocksOfIllusionMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
